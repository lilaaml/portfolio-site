...
const Intro = () => {
    return (
      <div className="container-sm d-flex flex-column flex-wrap justify-content-sm-center mt-5">
        ...
        <a href="https://drive.google.com/file/d/1BMcv97j8cXZx4kntfjLF6UvIyy6CzO6O/view" className="btn btn-secondary my-2">Download my Portfolio</a>
      </div>
    )
  }
