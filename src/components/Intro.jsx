...
const Intro = () => {
    return (
      <div id="intro" className="container-sm d-flex flex-column flex-wrap justify-content-sm-center mt-5 col-md-6">
        ...
        <p className="lead">I put all of my creativity into making UI/UX designs for web applications that are both aesthetically pleasing and responsive. Explore my portfolio to see the projects I&apos;ve worked on!</p>
